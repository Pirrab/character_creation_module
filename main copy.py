...
def attack(char_name: str, char_class: str) -> str:
    """Вычисление количества нанесённого урона в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисление количества заблокированного урона в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применение специальных умений в зависимости от класса."""
    if char_class == 'warrior':
